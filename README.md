...
Another extension is speaker-conditional Fed communication. Prior research on FOMC voting-right rotation shows that Reserve Bank presidents communicate differently when they are voting versus non-voting members, and that Treasury markets react differently to those speeches. A future version of this project could test whether prediction markets correctly weight Fed communications by speaker role, voting status, regional information content, hedging intensity, and pre-meeting timing.
